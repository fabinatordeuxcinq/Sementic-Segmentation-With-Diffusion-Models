...
class TrainLoop:
    def __init__(
        ...
        *,
        ...
        # now we have this to track in_channels
        self.in_channels = self.diffusion.in_channels
        self.out_channels = self.diffusion.out_channels
    ...
    def run_loop(self):
        ...
        while (
            self.step <= self.training_steps and
